...
/*   Updated: 2022/12/08 15:31:35 by kcatrix          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	verif_file(stock->pathspritee);
	verif_file(stock->pathspriten);
	verif_file(stock->pathspritew);
	verif_file(stock->pathsprites);
	r->mlx = mlx_init();
